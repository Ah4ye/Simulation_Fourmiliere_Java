...
public class Fourmiliere {
  ...
  // recupere une fourmi de la liste fourmi 
...
public List<Fourmi> getListFourmi (){
  ...
  public void realloc( int hauteur , int largeur){
 ...
 public void setQteGraines(int x, int y, int qte) {
    ...
    this.nbGraines -=  this.qteGraines[y][x];
  ...
  public void resetQteGraines(){
    for (int i = 0; i < this.qteGraines.length; i++) {
    for (int j = 0; j < this.qteGraines[i].length; j++) {
        qteGraines[i][j] = 0;
    }
    }
    this.nbGraines = 0;
